	...
	<section class="wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ul class="breadcrumb">
					<li>
						<a href="${BASE_PATH}/manage/admin/permission/list.htm?adminId=${SESSION_ADMIN.adminId}">
						<i class="icon-home"></i>管理员权限</a>
					</li> 			
				</ul>
				<!--breadcrumbs end -->
			</div>
			...
			<div class="col-lg-4">
				<section class="panel">
					...
					<div class="panel-body">
						 <form id="add_adminFolder_form" method="post" class="form-horizontal" autocomplete="off" action="${BASE_PATH}/manage/admin/permission/addFolder.json">
							<fieldset>
        ...
        bootbox.dialog({
            ...
            buttons: {
                "delete": {
                    ...
                    callback: function() {
                        $.post("${BASE_PATH}/manage/admin/permission/delete.json", {
                            "folderId": folderId,
                            "adminId": adminId
                        },
                        function(data) {
