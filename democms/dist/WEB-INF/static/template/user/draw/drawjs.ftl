...
<body class="MerryBody">
 ...
 <div class="swiper-container">
    <div class="swiper-wrapper">
      <div class="swiper-slide"><a href="http://wx.10086.cn/website/score/index/new"  style="color:#000;"><img src="${TEMPLATE_DRAW_PATH}/images/footer.jpg"></a><span style=" position:absolute; right:10px; font-size:16px; top:10px; color:Gray;">广告</span></div>
      <div class="swiper-slide"><a href="http://wx.10086.cn/website/score/index/new"  style="color:#000;"><img src="${TEMPLATE_DRAW_PATH}/images/footer.jpg"></a><span style=" position:absolute; right:10px; font-size:16px; top:10px; color:Gray;">广告</span></div>
    </div>
  </div>
...
<script type="text/javascript">
	...
	(function(){ 
		...
		var demo3 = document.getElementById("hand3"); 
		           		...
		           		if(typeof data.t != "undefined" && !$.isEmptyObject(data.t)){
		           			...
		           			$.each(data.t,function(i,n){
		           				...
		           				var datetime = ((myDate.getMonth() + 1) > 10 ? (myDate.getMonth() + 1) : "0"+ (myDate.getMonth() + 1))
 		           				...
 		           				html += "<tr><td>"+i+"</td><td>"+n.mobilePhone+"</td><td>"+n.name+"</td><td>"+datetime+"</td></tr>";
		           			})
		           			$(".winBody").append(html);
		           		}else{
