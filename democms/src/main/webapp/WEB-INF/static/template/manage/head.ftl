	...
	<section id="container" class="">
		...
		<header class="white-bg">
			<div class="container" style="background-color: #ffffff; padding: 10px;">
				<!--logo start-->
				<a href="${BASE_PATH}/draw/come.htm" class="logo" title="访问前台页面">
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu">
						<a <#if menu="headline">class="active"</#if> href="${BASE_PATH}/manage/headline/view.htm" <i class="icon-desktop"></i> <span>首页</span></a>
					</li>
					<li class="">
						<a <#if menu="admin_list">class="active"</#if> href="${BASE_PATH}/manage/admin/manage.htm"> <i class="icon-user"></i> <span>管理员管理</span></a>
					</li>
					<li class="">
						<a <#if menu="user_list">class="active"</#if> href="${BASE_PATH}/manage/user/list.htm"> <i class="icon-user"></i> <span>用户管理</span></a>
					</li>
					<li class="">
						<a <#if menu="prize_list">class="active"</#if> href="${BASE_PATH}/manage/prize/list.htm"> <i class="icon-user"></i> <span>奖品列表</span></a>
					</li>
					<li class="">
						<a <#if menu="prizeHistory_list">class="active"</#if> href="${BASE_PATH}/manage/prizeHistory/list.htm"> <i class="icon-user"></i> <span>中奖纪录</span></a>
					</li>
					<li class="">
						<a <#if menu="loginLog_list">class="active"</#if> href="${BASE_PATH}/manage/loginLog/list.htm"> <i class="icon-user"></i> <span>访问纪录</span></a>
					</li>
					<li class="">
						<a <#if menu="statistics_list">class="active"</#if> href="${BASE_PATH}/manage/prizeHistory/statistics.htm"> <i class="icon-user"></i> <span>中奖统计</span></a>
					</li>
					<li class="">
