...
public class ConfigManageAction extends BaseManageAction{
	...
	public String index(HttpServletRequest request,ModelMap modelMap){
		try {
//			modelMap.addAttribute(ConfigConstant.DEMO_DRAW_RULE, configService.getConfigByKey(ConfigConstant.DEMO_DRAW_RULE));
			modelMap.addAttribute(ConfigConstant.DEMO_USER_DRAWCOUNT, configService.getConfigByKey(ConfigConstant.DEMO_USER_DRAWCOUNT));
